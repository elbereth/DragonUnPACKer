...
begin
  ...
  begin
    ...
    strSettings.Caption := DLNGStr('HR1019');
    strSettings.Font.Name := getFont();
    strScanned.Caption := DLNGStr('HR1016');
    strScanned.Font.Name := getFont();
    strLeftToScan.Caption := DLNGStr('HR1017');
    strLeftToScan.Font.Name := getFont();
    strEstimated.Caption := DLNGStr('HR1015');
    strEstimated.Font.Name := getFont();
    strElapsed.Caption := DLNGStr('HR1018');
    strElapsed.Font.Name := getFont();
    cmdOk.Caption := DLNGStr('BUTOK');
    cmdOk.Font.Name := getFont();
