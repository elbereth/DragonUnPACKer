...
AppVerName=Dragon UnPACKer v5.7.1 Beta (unstable)
...
AppCopyright=Mozilla Public License 2.0
...
VersionInfoTextVersion=5.7.1 Beta
VersionInfoCopyright=Elbereth / MPL 2.0
VersionInfoProductName=Dragon UnPACKer
VersionInfoProductVersion=5.7.1
AppVersion=5.7.1 Beta
