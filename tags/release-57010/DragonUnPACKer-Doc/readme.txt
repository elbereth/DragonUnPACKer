Dragon UnPACKer v5.0.0 Release Candidate 4                             Freeware
©Copyright 1997-2004 Alex Devilliers                                 08/05/2004
===============================================================================
...
stay intact, and no files can be added to the zip file.
 ...
 This program have 2 differents types of releases (same content):
    SETUP - ~2.9Mb - dup500rc4-setup.exe   - With Install/Uninstall
       7Z - ~1.5Mb - dup500rc4.7z          - Plain 7-Zip (v3.13) archive
...
+english.lng                  12 KB  English translation of DUP5
 homepage.uht                 22 KB  Create list template "DUP4 Style"
+spanish.lng                  13 KB  Spanish translation of DUP5
 ...
 cnv_pictex.d5c              448 KB  Textures convert plugin (v1.0.4 Beta)
 ...
 drv_default.d5d             187 KB  Main driver plugin (v1.3.1 RC)
 drv_giants.d5d               49 KB  Giants GZP driver plugin (v1.0.1)
 drv_mix.d5d                  64 KB  WestWood MIX driver plugin (v1.1.4 Beta)
                                     By Felix Riemann
 drv_ut.d5d                  408 KB  UT Packages driver plugin (v2.1.0)
 drv_zip.d5d                  54 KB  ZIP driver plugin (v1.0.3)
 unzip32.dll                  96 KB  Info-Zip's UnZip32.Dll v5.50

 data\hyperripper\
 hr_default.d5h              430 KB  Default HyperRipper plugin (v5.0.1c)

 utils\
 duppi.exe                   771 KB  DUP5 Package installer (v2.0.2)
 ...
 english.ls                   16 KB  English translation sources
 english-beta2-changes.txt     4 KB  Changes in english.ls between Beta 1 and 2
 english-beta3-changes.txt     4 KB  Changes in english.ls between Beta 2 and 3
 english-rc1-changes.txt       2 KB  Changes between Beta 3 and RC1
 english-rc2-changes.txt       2 KB  Changes between RC1 and RC2
 english-rc3-changes.txt       2 KB  Changes between RC2 and RC3
 flag_sp.bmp                   1 KB  Spain flag icon
 flag_us.bmp                   1 KB  USA flag icon
 spanish.ls                   14 KB  Spanish translation sources
...
-------------------------------------------------------------------------------
  ...
  * Windows 98/ME/NT/2000/XP/2003.
    Tested under Windows 98, ME, 2000 and XP.
    Does not work under Windows 95.

 Author's computer:

  * Antec Plus 1080 AMG case
  * Enermax EG465AX-VE(G) FMA power supply
  * Gigabyte 7NNXP (BIOS vF13)
  * AMD Athlon XP 3200+
    Termalright SLK-900 with NoiseBlocker S4 fan
  * 1024MB (2x512MB) of DDRam Samsung PC2700
  * Hard Disk Maxtor   200GB  7200rpm  SATA150  8MB cache
    Hard Disk Maxtor   200GB  7200rpm  UDMA133  8MB cache
    Hard Disk WD       160GB  7200rpm  UDMA100  8MB cache
    Hard Disk Maxtor   120GB  7200rpm  SATA150  8MB cache
    Hard Disk Maxtor   120GB  7200rpm  UDMA133  8MB cache
    Hard Disk IBM      120GB  7200rpm  UDMA100
    Hard Disk IBM       61GB  7200rpm  UDMA100/USB 2.0 external case
  * Pioneer DVR-105 DVD-RW 4x burner
    Lite-On LTR-48125W CD-RW 48x burner
    Pioneer DVD-116 DVD reader in USB 2.0 external case
  * Sound Blaster Audigy 2 ZS sound card
  * PowerColor Radeon 9800 Pro (128MB) graphic card
...
-------------------------------------------------------------------------------
 ...
 Write me only in french, english or spanish.
  ...
  E-Mail: dup500rc3 (at) dragonunpacker (DOT) com
...
-------------------------------------------------------------------------------
 ...
 Info-ZIP for the UnZip32.DLL v5.50 (allowing ZIP file listing/extraction)
        By Info-ZIP group
        Portions:
