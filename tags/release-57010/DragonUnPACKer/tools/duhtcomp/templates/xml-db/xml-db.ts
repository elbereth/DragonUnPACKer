...
# Can be up to 255 characters
#
Email = xml-db.dup5template@elberethzone.net
#
# + URL +
...
#
ExtInfo = eXtended Markup Language
#
# + Files +
...
#
IncludeFile = dup5-xml-db.dtd
#
# End of XML Database Template Source File
#
{/TSF}
