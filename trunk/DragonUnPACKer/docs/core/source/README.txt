...
Licence 2.0. Read LICENCE.txt for more information.
...
Borland Delphi 7.1 Personal). I know it is not easy to find nowadays.
You obviously also need some Delphi programming skills. :P

Lazarus/FPC compilation can be tried, the current version can be compiled
...
- FastMM v4.991                   http://fastmm.sf.net
- FastCode v0.6.4                 http://fastcode.sourceforge.net/
- FastMove v3.03                  http://fastcode.sourceforge.net/
...
For setup compilation you need Inno Setup v5.5.4 from:
